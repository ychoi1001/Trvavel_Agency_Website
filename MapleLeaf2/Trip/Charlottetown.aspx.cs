...
{
    public partial class Charlottetown : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@City", "Charlottetown");
                ...
                {
                    bookingErro.Text = "No trips in Charlottetown";
                }
        ...
        public void SaveBooking(object sender, EventArgs e)
        {
            ...
            if (count == 0)
            {
                try
                {
                    sqlString = "INSERT INTO AspNetBookings  ( City, StartDate,EndDate, UserId) VALUES ( 'Charlottetown', @StartDate, @EndDate, @UserId)";
                    ...
                    bookingErro.Text = "Booking success. Charlottetown: " + bookingDate.Text;
                }
                catch (Exception ex)
                {
