...
{
    public partial class Vancouver : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@City", "Vancouver");
                ...
                {
                    bookingErro.Text = "No trips in Vancouver";
                }
        ...
        public void SaveBooking(object sender, EventArgs e)
        {
            ...
            if (count == 0)
            {
                try
                {
                    sqlString = "INSERT INTO AspNetBookings  ( City, StartDate,EndDate, UserId) VALUES ( 'Vancouver', @StartDate, @EndDate, @UserId)";
                    ...
                    bookingErro.Text = "Booking success. Vancouver: " + bookingDate.Text;
                }
                catch (Exception ex)
                {
