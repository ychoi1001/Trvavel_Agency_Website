...
{
    public partial class Banff : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@City", "Banff");
                ...
                {
                    bookingErro.Text = "No trips in Banff";
                }
        ...
        public void SaveBooking(object sender, EventArgs e)
        {
            ...
            if (count == 0)
            {
                try
                {
                    sqlString = "INSERT INTO AspNetBookings  ( City, StartDate,EndDate, UserId) VALUES ( 'Banff', @StartDate, @EndDate, @UserId)";
                    ...
                    bookingErro.Text = "Booking success. Banff: " + bookingDate.Text;
                }
                catch (Exception ex)
                {
