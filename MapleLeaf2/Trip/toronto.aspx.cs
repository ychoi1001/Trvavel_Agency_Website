...
{
    public partial class toronto : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@City", "Toronto");
                ...
                {
                    bookingErro.Text = "No trips in Toronto";
                }
        ...
        public void SaveBooking(object sender, EventArgs e)
        {
            ...
            if (count == 0)
            {
                try
                {
                    sqlString = "INSERT INTO AspNetBookings  ( City, StartDate,EndDate, UserId) VALUES ( 'Toronto', @StartDate, @EndDate, @UserId)";
                    ...
                    bookingErro.Text = "Booking success. Toronto: " + bookingDate.Text;
                }
                catch (Exception ex)
                {
